...
describe("Book Component TS methods Testing", ()=>{
    ...
    beforeEach(()=>{
        ...
        appointmentData=[
            ...
            totime:"17:17",drid:"1",patientid:"1",isApproved:true,reason:"",description:"Apendix",drDisplayId:"",patientDisplayId:"",speciality:"Surgan"}
         ]
    ...
    it(" should load the doctor data",()=>{
     ...
     it(" Submitting form emits appoinment object",()=>{
         ...
         fixture.componentInstance.doctorsdata={patientid:1};
